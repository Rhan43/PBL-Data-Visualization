...
levels(LE_clean$SMKDSTY) <- c("Daily", "Former daily current occasional", "Never daily current occasional", "Former daily current nonsmoker", "Never daily current smoker (former occasional)", "Never Smoker", "Missing")
LE_clean
